              ...
              <div className="row">
                <div className="container">
                  <div className="d-flex justify-content-between align-items-center">
                    <h2>HASTALAR</h2>
                    <button className="button-33" role="button">Yeni Hasta Ekle</button>
                  </div>
                            ...
                            <li key={index} className="table-row">
                                ...
                                <div className="col col-5">
                                    <div className="btn-group">
                                        ...
                                        <a className="btn btn-primary btn-sm" title="Hastayı Düzenle">
                                            <i className="ri ri-edit-2-fill"></i>
                                        </a>
                                        <span style={{marginRight: 10}} />
                                        <a className="btn btn-danger btn-sm" title="Hastayı Sil"><i className="bi bi-trash" /></a>
                                    </div>
                                </div>
                            </li>
                          ))}
